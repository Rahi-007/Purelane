...
const categories = [
    { name: "Organic Honey", image: "/category/category_01.jpg" },
    { name: "Chicken Noodle", image: "/category/category_02.jpg" },
    { name: "Juice", image: "/category/category_03.jpg" },
    { name: "Groceries", image: "/category/category_04.jpg" },
    { name: "Diabetic Cookies", image: "/category/category_05.jpg" },
];
